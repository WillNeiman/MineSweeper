...
//
//import com.will.Minesweeper.service.MineBoard;
...
//
////@Component
//public class OldMineSweeperProcessor {
//
...
////        return false;
////    }
//    public char[][] process2D(char[][] newBoard, int y, int x) {
//        this.board = new MineBoard(newBoard);
//        int height = board.getHeight();
//        int width = board.getWidth();
//        char[][] initialBoard = board.getInitialBoard();
...
//    }
//
//    public boolean isGameOver2D(char[][] resultBoard) {
